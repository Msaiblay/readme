                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="isbn" placeholder="Enter Book's Title " name="isbn" value="{{ $book->isbn }}">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12 form-group">
                                                ...
                                                <input type="text" class="form-control" id="title" placeholder="Enter Book's Title " name="title" value="{{ $book->title}}">

                                            </div>

                                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12 form-group">
                                                <label for="mmtitle"> Myanmar Title </label>
                                                <input type="text" class="form-control" id="mmtitle" placeholder="Enter Book's Myanmar Title " name="mmtitle" value="{{ $book->mmtitle}}">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="isbn" placeholder="Enter Book's Title " name="isbn" value="{{$book->annotation}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="page" placeholder="Book's Page " name="page" value="{{ $book->pages}}">
                                        </div>

                                        <div class="form-group">
                                            <label> Author's Name </label>
                                            <select class="form-control select2" name="authorsid[]" multiple="multiple">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="genresid[]" multiple="multiple">
                                                ...
                                                <div class="tab-pane fade show active" id="pills-price" role="tabpanel" aria-labelledby="pills-price-tab">
                                                    <div class="row form-group">
                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                            ...
                                                            <input type="number" name="price" class="form-control" placeholder="Enter Book's Price" id="price"  value="{{ $book->price}}">
                                                        </div>

                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                            <label for="discount"> Discount </label>
                                                            <input type="number" name="discount" class="form-control" placeholder="Enter Book's Discount" id="discount" value="{{ $book->discount}}">
                                                        </div>
