                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a class="btn btn-outline-primary btn-round ms-auto" href="{{route('genre.index')}}">
                                <i class="icofont-rounded-double-left"></i>
                                Go Back
                            </a>
                        </div>
                    </div><form action="{{ route('genre.update', $genre->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control @error('name')is-invalid @enderror" id="name_id" name="name" value="{{ $genre->name }}" >
                                    <input type="hidden" value="{{ $genre->name }}" name="oldname">
